...
## 🚢 ก้าวนำไปอีกหลายขั้น: ไปไกลกว่า 10,000 ไมล์ จากขั้นพื้นฐาน

ออกเดินทางเรียนรู้ตั้งแต่ขั้นพื้นฐานจนไปถึงขั้นสูง ไม่ว่าจะเป็น การทดสอบระบบบน production, การทดสอบแบบเปลี่ยนรูป, การทดสอบตามคุณสมบัติ และอื่นๆ ได้แก่ เครื่องมือที่จะช่วยสร้างกลยุทธ์และความเป็นมืออาชีพ หากคุณอ่านและเข้าใจคู่มือนี้ทุกตัวอักษร ทักษะการทดสอบของคุณจะสูงกว่าคนทั่วไปอย่างแน่นอน

## 🌐 ครบทุก stack : มีทั้ง Frontend, Backend, CI และอื่นๆ

เริ่มต้นด้วยการทำความเข้าใจกับแนวทางการทดสอบที่แพร่หลายซึ่งเป็นหลักการพื้นฐานสำหรับการพัฒนาแอพลิเคชั่น จากนั้นเจาะลึกไปในแต่ละส่วนที่คุณสนใจ ได้แก่ ส่วนหน้า/UI, ส่วนหลัง, และ CI หรือคุณจะดูทั้งหมดเลยก็ย่อมได้
