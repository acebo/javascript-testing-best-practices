...
# 👇 เหตุผลที่คู่มือนี้จะช่วยยกระดับสกิลการเขียนเทสของเราให้สูงขึ้นไปอีกขั้น
...
มีความน่าเชื่อถือสำหรับ JavaScript และ Node.js โดยมีการสรุปและกลั่นกรองเนื้อหาจากแหล่งความรู้ที่ดีที่สุด ไม่ว่าจะเป็นบล็อกต่างๆ หนังสือ และเครื่องมือที่เป็นที่นิยม 
นี่คือคู่มืิอสำหรับ JavaScript และ Node.js ที่มีความน่าเชื่อถือตั้งแต่ต้นจนจบ โดยมีการสรุปและกลั่นกรองเนื้อหาจากแหล่งความรู้ที่ดีที่สุด ไม่ว่าจะเป็นบล็อกต่างๆ หนังสือ และเครื่องมือที่เป็นที่นิยม

## 🚢 Advanced: Goes 10,000 miles beyond the basics
ขั้นสูง : ไปไกลกว่า 10,000 ไมล์ จากขั้นพื้นฐาน
...
ออกเดินทางเรียนรู้ตั้งแต่ขั้นพื้นฐานจนไปถึงขั้นสูง ไม่ว่าจะเป็น การทดสอบบน production, การทดสอบแบบเปลี่ยนรูป, การทดสอบตามคุณสมบัติ และเครื่องมือที่ช่วยสร้างกลยุทธ์และความเป็นมืออาชีพอีกมากมาย หากคุณอ่านและเข้าใจคู่มือนี้ทุกตัวอักษร ทักษะการทดสอบของคุณจะสูงกว่าคนทั่วไปอย่างแน่นอน

## 🌐 Full-stack: front, backend, CI, anything
ครบทุกรูปแบบ : ทั้ง Frontend, Backend, CI และอื่นๆ
...
เริ่มต้นด้วยการทำความเข้าใจกับแนวทางการทดสอบที่แพร่หลายซึ่งเป็นหลักการพื้นฐานสำหรับการพัฒนาแอพลิเคชั่น จากนั้นจึงเจาะลึกไปในแต่ละส่วนที่คุณสนใจ: ส่วนหน้า, ส่วนหลัง, CI หรืออาจจะทั้งหมดก็ได้
...
#### [`Section 0: The Golden Rule บทที่ 0: กฎทอง หลักการพื้นฐาน`](#section-0️⃣-the-golden-rule)
