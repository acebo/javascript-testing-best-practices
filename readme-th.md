...
# 👇 เหตุผลที่คู่มือนี้จะช่วยยกระดับสกิลการเขียน Test ของเราให้สูงขึ้นไปอีกขั้น
...
เรียนรู้ตั้งแต่ขั้นพื้นฐานจนไปถึงขั้นสูง ไม่ว่าจะเป็น การทดสอบระบบบน production, การทดสอบแบบเปลี่ยนรูป, การทดสอบตามคุณสมบัติ และอื่นๆ ได้แก่ เครื่องมือที่จะช่วยสร้างกลยุทธ์และความเป็นมืออาชีพ หากคุณอ่านและเข้าใจคู่มือนี้ทุกตัวอักษร ทักษะการทดสอบของคุณจะสูงกว่าคนทั่วไปอย่างแน่นอน

## 🌐 ครบทุก stack : มีทั้ง Frontend, Backend, CI และอื่นๆ

เริ่มต้นด้วยการทำความเข้าใจกับแนวทางการทดสอบที่แพร่หลายซึ่งเป็นหลักการพื้นฐานสำหรับการพัฒนาแอพลิเคชั่น จากนั้นเจาะลึกไปในแต่ละส่วนที่คุณสนใจ ได้แก่ Frontend/UI, Backend, และ CI หรือคุณจะดูทั้งหมดเลยก็ย่อมได้
...
#### [`บทที่ 0: กฎทองคำ`](#section-0️⃣-the-golden-rule)

คำแนะนำเพียงข้อเดียวที่จุดประกายข้ออื่นๆ (1 หัวข้อพิเศษ)

#### [`บทที่ 1: โครงสร้างการทดสอบ`](#section-1-the-test-anatomy-1)

หลักการพื้นฐาน - จัดโครงสร้าง Clean Tests (12 หัวข้อ)

#### [`บทที่ 2: ส่วนหลังบ้าน (Backend)`](#section-2️⃣-backend-testing)

การเขียน Test ของส่วนหลังบ้านและ Microservices ให้่มีประสิทธิภาพ (8 หัวข้อ)

#### [`บทที่ 3: ส่วนหน้าบ้าน (Frontend)`](#section-3️⃣-frontend-testing)

การเขียน Test ส่วน UI บนหน้าเว็บ ทั้งส่วนการทดสอบ Component และ E2E (11 หัวข้อ)

#### [`บทที่ 4 การวัดผลประสิทธิภาพของการทดสอบ`](#section-4️⃣-measuring-test-effectiveness)

ติดตามผล - การวัดคุณภาพของการทดสอบ (4 หัวข้อ)

#### [`บทที่ 5: Continuous Integration`](#section-5️⃣-ci-and-other-quality-measures)

คู่มือสำหรับ CI ในโลกของ JavaScript (9 หัวข้อ)
...
## ⚪️ 0 กฎทองคำ: ออกแบบ test แบบลีนๆ

:white_check_mark: **ควรทำ:**
ออกแบบ test ให้ง่ายที่สุด, สั้น, ไม่ซับซ้อน, และเข้าใจง่าย เมื่อมีคนอื่นอ่านแล้วควรจะเข้าใจได้ในทันที

ตามปกติโปรแกรมที่เราเขียนก็มักจะมีความซับซ้อนอยู่แล้ว การที่เราพยายามจะเขียน test ให้มีความซับซ้อนอีก ก็จะทำให้การทำงานของทีมช้าลง เพราะต้องพยายามเข้าใจหลายส่วน ซึ่งนี่เป็นเป็นเหตุผลที่หลายๆ ทีมได้ละทิ้งการเขียน test ไป

test ที่เราเขียนไว้นั้น ถือว่าเป็นเหมือนการสร้างผู้ช่วย ที่ทำงานด้วยสนุก ลงทุนน้อย แต่ได้ผลตอบแทนที่คุ้มค่า ช่วยเราได้มาก
นักวิทยาศาสตร์กล่าวว่าเรามีสมอง 2 ระบบ ระบบที่หนึ่งใช้เพื่อกิจกรรมง่ายๆ เช่น การขับรถบนถนนว่างๆ และ ระบบที่สองใช้สำหรับความซับซ้อน เช่น การแก้ปัญหาทางคณิตศาสตร์ โอเค เพราะงั้นการออกแบบ test ควรเปรียบกับการใช้สมองระบบที่ 1 คืออ่านแล้ว _รู้สึก_ ง่ายในการปรับเปลี่ยน ไม่ใช่ยากเหมือนเวลาเราเห็นโจทย์ 2X(17 × 24)

สิ่งเหล่านี้สำเร็จได้โดยการ เลือกทดสอบส่วนที่ควรทดสอบ รวมทั้งเลือกเครื่องมือและวิธีการที่คุ้มค่าที่สุด เพราะฉะนั้นการเขียน test ควรเขียนเท่าที่จำเป็น และ ทำให้มันว่องไว บางครั้งก็อาจจะต้องทิ้งการทดสอบบางส่วนออก เพื่อแลกกับความคล่องตัวและเรียบง่าย

![alt text](/assets/headspace.png "เราไม่มีพื้นที่ว่างให้กับความซับซ้อนอีก")

จากหลักการข้างต้น สามารถแยกออกมาเป็นคำแนะนำดังข้างล่างนี้

### พร้อมจะเริ่มกันเลยไหม?
...
## ⚪ ️ 1.1 ชื่อและคำอธิบาย test ประกอบไปด้วย 3 ส่วนหลัก
...
### :clap: ตัวอย่างที่ดี: ชื่อของ test ที่ประกอบไปด้วย 3 ส่วน
